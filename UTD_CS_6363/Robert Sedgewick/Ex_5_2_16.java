 ...
 * DOCUMENT SIMILARITY
 * 
 * Take another string from the input and store it
 * in a different file now construct a trigram trie for 
 * one, then take every trigram from the second file 
 * and get its rank in the other, 
 * if a matrix is constructed 
 * with the order of the string and the corresponding 
 * rank in the other as indices  storing 1 iff both of 
 * them have a trigram and 0 other wise.
 * 
 ******************************************/

public class Ex_5_2_16<Value> {
	
	private Node root;
	
	/*****************CONSTRUCTOR IMPLEMENTATION********************/
	
	public Ex_5_2_16(Scanner scan){
		Integer i=0;
